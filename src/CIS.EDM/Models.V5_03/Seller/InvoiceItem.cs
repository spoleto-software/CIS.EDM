...
namespace CIS.EDM.Models.V5_03.Seller
{
	...
	public record InvoiceItem
    {
		...
		/// <summary>
		/// Сумма акциза по подакцизным товарам (графа 6 счета-фактуры)
		/// </summary>
		/// <remarks>
		/// Элемент обязателен при наличии КодВидПр и при совершении налогоплательщиками операций,
		/// подлежащих налогообложению в соответствии с главой 22 НК
		/// </remarks>
		/// <value>
