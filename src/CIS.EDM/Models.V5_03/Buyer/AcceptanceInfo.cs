...
namespace CIS.EDM.Models.V5_03.Buyer
{
	...
	public record AcceptanceInfo
    {
		...
		/// </summary>
		/// <remarks>
		/// Содержание действий. Указывается, например, «Товары принял без претензий», «Результаты работ принял без претензий»,
        /// «Услуги получены, претензий нет» или другое, в том числе исходя из значения СпОбстФДОП информации продавца.
        /// При КодИтога = 3 элемент не формируется.
		/// </remarks>
