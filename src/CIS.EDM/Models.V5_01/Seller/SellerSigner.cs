...
namespace CIS.EDM.Models.V5_01.Seller
{
	...
	public record SellerSigner
	{
		...
		[Required]
		public SignerAuthority SignerAuthority { get; set; } = SignerAuthority.PersonResponsibleForSigningInvoice;
		...
		[Required]
		public SignerStatus SignerStatus { get; set; } = SignerStatus.SellerEmployee;
		...
		/// </summary>
		/// <remarks>
		/// Может быть использован кроме случаев, когда законодательством Российской Федерации предусмотрено
		/// подписание документа индивидуальным предпринимателем или представителем юридического лица Типовой элемент &lt;СвИПТип&gt;.
		/// </remarks>
